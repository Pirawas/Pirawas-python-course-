...
อย่าลืมเขียนโปรแกรมในส่วนของการทดลองใช้งาน ลูกค้า3คน
...
print(create_user_profile("nantiwat", 19, False))
print(create_user_profile("Peerawas", 19, True))
print(create_user_profile("Meena"))
